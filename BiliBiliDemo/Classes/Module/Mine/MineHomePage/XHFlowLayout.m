...
NSString * const XHCollectionElementKindSectionHeader = @"XHCollectionElementKindSectionHeader";
NSString * const XHCollectionElementKindSectionFooter = @"XHCollectionElementKindSectionFooter";

@interface XHFlowLayout()
{
    CGSize _itemSize;
...
@property (weak, nonatomic) id<XHCollectionViewFlowLayoutDelegate> delegate;
...
- (void)prepareLayout
{
    ...
    self.delegate = (id<XHCollectionViewFlowLayoutDelegate>)self.collectionView.delegate;
    NSAssert([self.delegate conformsToProtocol:@protocol(XHCollectionViewFlowLayoutDelegate)], @"UICollectionView's delegate should conform to MUCollectionViewFlowLayoutDelegate protocol");
    NSAssert(self.columnCount > 0, @"MUCollectionviewFlowLayout's columnCount should be than 0 ");
    ...
    /** 此处修改为固定 值不准确为93 实应为93.75000*/
    self.itemWidth = APPW/4;
    ...
    {
        //1、section header
        UICollectionViewLayoutAttributes * headerAttributes = [self layoutAttributesForSupplementaryViewOfKind:XHCollectionElementKindSectionHeader atIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
        ...
        //3、section footer
        UICollectionViewLayoutAttributes * footerAttributes = [self layoutAttributesForSupplementaryViewOfKind:XHCollectionElementKindSectionFooter atIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([elementKind isEqualToString:XHCollectionElementKindSectionHeader])
    {
    ...
    else if ([elementKind isEqualToString:XHCollectionElementKindSectionFooter])
    {
